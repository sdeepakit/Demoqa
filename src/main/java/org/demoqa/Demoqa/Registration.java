...
public class Registration {
	...
	public void the_user_has_to_verifing_the_particular_country_and_date_of_birth_is_choosed_or_not() throws Throwable {
		...
		String country = driver.findElement(By.xpath("//option[@value='India']")).getText();
		 Assert.assertEquals(country, "India"); 
		 
		String month = driver.findElement(By.xpath("//option[@value='2']")).getText();
		 Assert.assertEquals(month, "2"); 
		 
		String date = driver.findElement(By.xpath("//option[@value='2']")).getText();
		 Assert.assertEquals(date, "2"); 
		 
		String year = driver.findElement(By.xpath("//option[@value='2000']")).getText();
